...
const FooterSection = () => {
  return (
    <section className="bg-dullBlue pt-1 md:pt-20">
      ...
      <small className="text-center text-sm block mx-auto pb-5">Built by <a href="https://x.com/davidcharlie_" target="_blank" rel="noopener noreferrer">@devCharlie</a></small>
    </section>
  );
};

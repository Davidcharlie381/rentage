...
const FooterSection = () => {
  return (
    <section className="bg-dullBlue pt-20">
      <div className="w-full md:w-[90%] md:max-w-7xl mx-auto bg-lightBlue p-5 py-16 md:py-24">
      ...
      <div className="container flex justify-between items-center mt-12 md:mt-36">
        <div>
          <svg
      ...
      <div className="flex justify-center items-center py-12 md:py-20">
        <ul className="flex flex-wrap justify-center gap-5 md:gap-10 items-center">

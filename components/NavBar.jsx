...
const NavBar = ({ handleClose, open }) => {
  return (
    <section
      ...
      } fixed z-[999] transiton-all duration-500 bg-lightBlue opacity-[0.97] w-screen h-screen inset-0`}
    >
      <div className="container flex flex-col gap-10 pt-5">
        ...
        <Link
          href="/login-register"
          className="text-center text-[21px] font-bold hover:text-orange"
        >
          Sign in
        </Link>
